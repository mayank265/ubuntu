...
sudo apt-get --ignore-missing install -y mysql-server wireshark phpmyadmin virtualbox-ext-pack virtualbox
...
sudo apt-get --ignore-missing install -y copyq conky-all geany atril flameshot
